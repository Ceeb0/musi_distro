...
export const Marketplace: React.FC<MarketplaceProps> = ({ beats, loading, playTrack, currentTrack, isPlaying, onPurchase, isArtist, favoritedBeatIds, onToggleFavorite, onViewProducer, formatCurrency }) => {
    ...
    const handleBuyClick = (beat: Beat) => {
        ...
        if (beat.isFree) {
            // Free beats can be "purchased" directly without a contract
                    ...
                    <div className="w-full">
                        <div className="relative mb-6">
                            <input
                                ...
                                className="w-full bg-gray-900/50 backdrop-blur-md border border-white/10 rounded-xl py-3 pl-12 pr-4 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500"
                            />
                        ...
                        {loading ? (
                            ...
                            {Array.from({ length: 8 }).map((_, i) => (
                                <div key={i} className="bg-gray-800/50 backdrop-blur-md border border-white/10 rounded-xl p-4 animate-pulse">
                                    <div className="aspect-square bg-gray-700/50 rounded-md mb-4"></div>
